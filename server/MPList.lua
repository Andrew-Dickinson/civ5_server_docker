...
function TelegraphPlayerStatus()
	local modUserData = Modding.OpenUserData("TurnStatus", 1);
	...
	print("PlayersWhoNeedToTakeTheirTurn: ", current_turn_status);
...
--GameEvents.GameCoreUpdateBegin.Add(TelegraphPlayerStatus);
Events.MultiplayerGamePlayerDisconnected.Add(TelegraphPlayerStatus);
